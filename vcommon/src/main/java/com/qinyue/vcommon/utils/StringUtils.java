...
public final class StringUtils {
     ...
     * @return
     */
    public static String replaceBlankWithIOS(final String str) {
        String dest = "";
        if (str != null) {
            Pattern p = Pattern.compile("\\s*|\t|\r|\n");
            Matcher m = p.matcher(str);
     ...
     * @return
     */
    public static String getZanNum(int zanNum) {
        if (zanNum<=0){
            return "0";
        }else if (zanNum<1000){
            return zanNum+"";
     ...
     * @return
     */
    public static String getGiftValue(long zanNum) {
        if (zanNum<=0){
            return "0";
        }else if (zanNum<1000){
            return zanNum+"";
        }else {
            double zan =  zanNum/1000d;
            String format = String.format("%.1f", zan);
            return format+"k";
        }
    }
    /**
