...
public final class AppUtils {
     ...
     * @return json 格式字符串
     */
    public static String getTrackId(String pkgName) {
        String TAG = "getTrackId";
        String trackId = null;
        Cursor cursor = null;
        Uri uri = Uri.parse(PROVIDER_URI);
        ContentResolver contentResolver = XUtil.getContentResolver();
        ...
        try {
            ...
            if (cursor != null) {
                ...
                if (cursor.getColumnCount() > INDEX_TRACKID) {
                    ...
                    // 不支持归因信息
                    Logger.i(TAG+ "appgallery not support");
                }
            }
        } finally {
            if (cursor != null) {
...
//            }
        ...
        Logger.i(TAG+"getTrackId  获取 trackid---" + trackId);
//        Toast.makeText(this, "track id is : " + trackId, Toast.LENGTH_LONG).show();
     ...
     * 是不是模拟器
     */
//    public static boolean getSimulator(Context context) {
//        boolean isSimulator = false;//是不是模拟器
//        try {
//            isSimulator = EmulatorDetectUtil.isEmulator(context);
//        } catch (Exception e) {
//            isSimulator = false;
//        }
//        return isSimulator;
...
//        }
    ...
    public static boolean cover(View view){
        boolean cover = false;
        Rect rect = new Rect();
